<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HTLX.Login" %>
...
<body>
    <div class="login-container" style="background-image: url('images/z486047177692_291b6f2187119116fdc9156bf1f3f2c0.jpg'); background-repeat: no-repeat">
        ...
        <h2 style="font-family: 'SVN-New Athletic M54'; font-weight: normal;">
            ...
            <label for="sdt" style="font-family: 'SVN-New Athletic M54'; font-weight: lighter">Số điện thoại:<asp:TextBox ID="txtPhone" runat="server" CssClass="center-textbox"></asp:TextBox>
            </label>
            &nbsp; 
            <label for="password" style="font-family: 'SVN-New Athletic M54'; font-weight: lighter">Mật khẩu:<asp:TextBox ID="txtPassword" runat="server" CssClass="center-textbox" TextMode="Password"></asp:TextBox>
            </label>
            &nbsp;         
           ...
           <br />
                <br />
                <a href="#">Quên mật khẩu</a> hoặc <a href="Registration.aspx">Đăng ký</a>
                <br /><br />
            <a href="LoginAdmin.aspx">Đăng nhập với tư cách quản trị viên?</a>
        </form>
    </div>
